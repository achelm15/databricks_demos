...
temp_table_name = "temp_mlb_gumbo_raw_data_stream"
...
def upsert_to_silver(batch_df, batch_id):
    silver_table_name = "mlb_demos.mlb_gumbo_silver.pitch_data"  # Unity Catalog table name
